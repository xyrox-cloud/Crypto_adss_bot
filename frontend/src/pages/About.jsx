  ...
  return (
    <div className="pb-24">
      ...
      <div className="bg-secondary px-6 py-6 rounded-none text-black relative mb-6">
        ...
        <h1 className="text-3xl font-extrabold uppercase leading-none">Blitz Game Zone — Tasks & Rewards</h1>
        <p className="text-black/70 font-mono text-sm mt-1">Version 1.0.0</p>
        <p className="mt-4 font-bold">"Complete daily tasks and earn real TON on Telegram"</p>
      </div>
      ...
      <div className="px-4">
        ...
        <div className="bg-cardbg border border-cardborder p-5 rounded-3xl">
          <p className="text-white/80 leading-relaxed text-sm mb-6">
            Blitz Game Zone rewards you for daily check-ins, completing tasks, and (optionally) watching ads. When you choose to watch an ad, the advertiser pays us, and we share <strong className="text-white">60% of that revenue</strong> directly back to you in TON. The remaining 40% covers server costs, transaction fees, and keeps the app running smoothly — with no hidden costs.
          </p>
